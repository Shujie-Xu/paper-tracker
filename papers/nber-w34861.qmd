...
<div style="display:flex; flex-wrap:wrap; gap:0.4rem; align-items:center; margin-bottom:1rem;">
  ...
  <span class="topic-tag">Text Methods</span>
</div>
```

**Authors:** Yijie Wang, Hao Gao, Campbell R. Harvey, Yan Liu, Xinyuan Tao

**Published:** 2026-02-25 · [View on NBER](https://www.nber.org/papers/w34861){target="_blank"}
· [PDF](https://www.nber.org/system/files/working_papers/w34861/w34861.pdf){target="_blank"}
